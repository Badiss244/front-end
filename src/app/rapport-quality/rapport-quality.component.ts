...
@Component({
  selector: 'app-rapport-quality',
  imports: [CommonModule, FormsModule],
  templateUrl: './rapport-quality.component.html',
  styleUrl: './rapport-quality.component.css'
})
export class RapportQualityComponent implements OnInit {
  reports: Report[] = [];
  errorMessage: string = '';
  ...
  fetchReports(): void {
    ...
    this.http.get<Report[]>('https://localhost:7299/api/Quality/rapports', { headers })
      .subscribe({
        next: (data) => {
          this.reports = data;
          this.loading = false;
